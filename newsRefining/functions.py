...
patterns= {'경향신문' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), (('▶', 1),)),
           '매일경제' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), ((r'\[', 1),)),
           '세계일보' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      ((r'[a-zA-Z0-9\._]+@segye.com', 0),('[ =,가-힣]*ⓒ', 1), ('ⓒ 세상을 보는 눈, 글로벌 미디어', 1))),
           '이코노미스트' : (( (r'\][ ]*\[', 0), (r'\]', 2)), 
                         ((r'([ 가-힣]*[-_\.0-9a-zA-Z]+@joongang\.co\.kr\[ⓒ 이코노미스트)', 1), 
                          ('※', 1), (r'[ 가-힣a-zA-Z]*\[ⓒ 이코노미스트', 1))),
           '한국경제TV' : (((r'\[국고처', 3), (r'\[인사\]',3 ), (r'\[[ 가-힣!]\]', 0)), 
           ...
           '동아일보' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      ((r'[ 가-힣=]+[a-zA-Z0-9\.]+@donga\.com', 1), (r'\[동아일보\]', 0), ('ⓒ 동아일보 ', 1),)),
           '문화일보' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      (('[ 가-힣=·]+[a-zA-Z0-9\.]+@', 1), (r'\[Copyrightⓒmunhwa\.com', 1),)),
           '연합뉴스' : (((r'\[부고\]', 3), (r'\[인사\]', 3), (r'\(종합\)', 0), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      (('※ 자료 :', 1),(r'\([가-힣]+=연합뉴스\)[ 가-힣]+기자 =', 0), (r'\([가-힣]+=연합뉴스\)', 0), 
                       (r'[a-zA-Z0-9\.]+@yna\.co\.kr', 0))),
           '조세일보' : (((r'\[부고\]', 3), (r'\[인사\]', 3), (r'\[포토\]', 0), (r'\[탐방\]', 0), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      (('▶▶', 1), ('저작권자 ⓒ 조세일보', 1),)),
           '한겨레' : (((r'\[부고\]', 3), (r'\[인사\]', 3), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                     ((r'[ 가-힣]+[a-zA-Z0-9\.]+@hani\.co\.kr▶', 1), ('▶ 한겨레 절친이 되어 주세요', 1), (r'\[한겨레\]', 0),)),
           'MBC 뉴스' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
           ...
           '디지털타임스' : (((r'\[부고\]', 3), (r'\[인사\]', 3), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
           ...
           '서울경제' : ((('오늘의 증시 메모', 4), (r'\[서울경제\]', 0), (r'\[서울경제TV\]', 0), (r'\[투데이포커스\]', 0), (r'\[표\]', 0), 
                       (r'\[S머니\]', 0), (r'\[이슈&워치\]', 0), (r'\[금주의 분양캘린더\]', 0), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
           ...
           '연합뉴스TV' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                        ((r'\[기자\]', 0), (r'\[앵커\]', 0), (r'\[비즈&\]', 0), (r'\[특별기획\]', 0), (r'\[기업기상도\]', 0), 
                         (r'\[뉴스초점\]', 0), (r'\[CEO풍향계\]', 0), ('[ 가-힣]*연합뉴스TV [가-힣]+입니다.', 1), 
                         ('연합뉴스TV : 02', 1))),
           '주간경향' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2)), ((r'© 주간경향 \(', 1),)),
           '한경비즈니스' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2)), (('▶', 1),)),
           'MBN' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2)),
           ...
           '매경이코노미' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2), (r'\[[가-힣]\]', 0)), 
                         (('\[', 1),)),
           '서울신문' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\]', 2)), 
                      ((r'[ 가-힣]+[a-zA-Z0-9\._]+@seoul\.co\.kr▶', 1), ('▶  재미있는 세상', 1), 
                        ('나우뉴스부★', 1), (r'▶ \[\]▶ \[\]'), (r'\[서울신문\]', 0))),
           '주간동아' : (((r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2), (r'\[[가-힣]\]', 0)), 
                      ((r'\[주간동아\]', 0), (r'\|[ 가-힣·=]+[a-zA-Z0-9@\._]+', 1), 
                       (r'[ 가-힣]+기자[ ]?[a-zA-Z0-9\._]+@donga\.com', 1))),
           'SBS CNBC' : (((r'\[인사\]', 3), (r'\[부고\]', 3), (r'\[[ 가-힣a-zA-Z0-9?!’‘]*\]', 0), (r'\][ ]*\[', 0), (r'\]', 2)),  
